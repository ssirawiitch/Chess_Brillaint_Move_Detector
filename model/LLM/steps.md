# 🌊 Vibecoding Steps: Chess Brilliant Move Predictor

นี่คือแผนการสร้างโปรเจกต์ด้วยการ "สั่งให้ AI เขียนโค้ดให้" (Vibecoding) โดยแบ่งเป็น 4 เฟสหลัก ให้คัดลอก **"Prompt"** ในแต่ละข้อไปสั่ง AI IDE (เช่น Cursor) ทีละสเตปครับ อย่าสั่งรวดเดียวนะครับ!

---

## 🛠️ Phase 1: Setup & Data Extraction (สกัดข้อมูล)
...
## ⚖️ Phase 2: Balancing & Formatting (จัดการ Imbalance & JSONL)
...
### 💡 กฎเหล็กตอน Vibe:
* รันโค้ดไปทีละ Step ถ้า **Step 2** รันแล้วติด Error (เช่น หาค่า delta_eval ไม่เจอใน PGN) **ห้ามไปทำ Step 3** ให้ก๊อป Error โยนกลับไปให้ AI แก้จนกว่าจะได้ไฟล์ `.csv` ที่สมบูรณ์
* หน้าที่ของ Will คือการเช็คความถูกต้องของ "ตรรกะหมากรุก" เช่น AI คำนวณ Material Diff ถูกหลักการไหม ถ้าไม่ถูก ก็พิมพ์บอกมันไปตรงๆ เลยครับ!

---

## 🤝 การส่งต่อโค้ดให้เพื่อน (สำหรับคนที่นำไปทำต่อ)
